...
// サイト共通要素（ヘッダー・フッター・ナビゲーション等）の文字
const COMMON_UI_TEXT =
  "na2zoraBlogRSSAllrightsreservedBuiltwithQwikCloudflarePagesAboutRecentUpdates技術ブログ記事一覧日々の技術的なメモや雑感を綴る場所です。最初のブログ記事へようこそ！これはで動いている個人サイトの最初の記事です。";
